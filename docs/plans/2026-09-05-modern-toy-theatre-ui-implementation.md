...
- [ ] **Step 1: Write failing asset/model tests**
...
- [ ] **Step 3: Generate and curate all 20 scene assets**
...
- [ ] **Step 4: Implement the pure resolver and asset README**
...
- [ ] **Step 1: Add failing HTML and pure helper tests**
...
- [ ] **Step 3: Add semantic shell and drawer markup**
...
- [ ] **Step 4: Implement shell lifecycle and titlebar mounts**
...
- [ ] **Step 5: Wire actual data and actions**
...
- [ ] **Step 6: Style against the drawer reference**
...
- [ ] **Step 1: Write failing presentation/path tests**
...
- [ ] **Step 3: Replace background probing with responsive candidates**
...
- [ ] **Step 1: Strengthen failing structure/style contracts**
...
- [ ] **Step 2: Confirm red for the new token contract**

Run: `cd app && python -m pytest tests/test_detail_layout.py -q`

Expected: 新 token 断言失败。

- [ ] **Step 3: Extract tokens and match the detail reference**
...
- [ ] **Step 4: Finish mobile and compact-window behavior**

小于 768px 使用媒体页签＋单列阅读；768–1023px 不挤压气泡；800×600 允许页面滚动但无横向溢出。真实视频保持 16:9，空状态可以更矮。隐藏媒体暂停；resize 不替换正在录制的 video DOM。

- [ ] **Step 5: Align profile/login/admin tokens without structural redesign**
...
- [ ] **Step 1: Write the isolated acceptance harness**
...
- [ ] **Step 2: Run browser acceptance at required sizes**
...
- [ ] **Step 3: Validate real Electron shell**
...
- [ ] **Step 6: Update project documentation and status**
