...
| Nodes and path | 2026-09-06 correction: empty numbered discs are compact 104/168px on desktop and 88/136px on mobile; cover discs expand separately. The route now has a ground shadow, warm sidewall, cream highlight and transverse stone seams. | Sign off after user feedback; honest empty states remain, but their form now matches the approved 3D toy language. |
| Topbar density | 2026-09-06 correction: circular cream menu, teal Stage capsule, cream progress capsule, dimensional avatar and Current action share highlight, lower edge and cast shadow while retaining real data. | Sign off; the previous “lighter flat controls” deviation is withdrawn because it materially weakened fidelity. |
