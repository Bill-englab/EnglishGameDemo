...
- [ ] **Step 1: Write loader tests against a temporary curriculum tree**
...
- [ ] **Step 4: Write validation tests for the Lesson contract**
...
- [ ] **Step 5: Implement structural and cross-Lesson validation**
...
- [ ] **Step 6: Add the Stage 4 policy file and authoring README**
...
- [ ] **Step 8: Commit the curriculum contract**
...
- [ ] **Step 6: Commit the validator command**
...
- [ ] **Step 1: Add a failing Chapter 1 content test**
...
- [ ] **Step 2: Run the Chapter 1 test and confirm missing content**
...
- [ ] **Step 3: Author the three Lessons**
...
- [ ] **Step 4: Run the validator and Chapter 1 tests**
...
- [ ] **Step 5: Read all three dialogues aloud and record the manual logic review**
...
- [ ] **Step 1: Add a failing Chapter 2 content test**
...
- [ ] **Step 2: Run the Chapter 2 test and confirm missing content**
...
- [ ] **Step 4: Validate structure and read the dialogue aloud**
...
- [ ] **Step 1: Add a failing Chapter 3 content test**
...
- [ ] **Step 2: Run the Chapter 3 test and confirm missing content**
...
- [ ] **Step 4: Validate structure, coverage, and dialogue logic**
...
- [ ] **Step 2: Write the Phase A review**
